    ...
    const adminRightSide = () => {
        return (
            <div className="card mb-4">
                ...
                <ul className="list-group">
                    <li className="list-group-item">
                        <span className="text-white bg-success p-1 mr-2">Name:</span> {name}
                    </li>
                    <li className="list-group-item">
                        <span className="text-white bg-success p-1 mr-2">Email:</span> {email}
                    </li>
                    <li className="list-group-item">
                        <span className="text-white bg-danger p-1 mr-2">Admin Area</span>
                    </li>
                </ul>
            </div>
        )
